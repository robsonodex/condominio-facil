...
|-------|------------|---------------------|
| Básico (R$ 149,90) | 48 horas | ❌ Não disponível |
| Profissional (R$ 249,90) | 12 horas | ❌ Não disponível |
| **Premium (R$ 399,90)** | **4 horas** | **✅ Disponível** |
...
- **🔴 Prioritário (priority)**: **Apenas Plano Premium** - Atendimento em 4h
