...
CREATE POLICY "Public view answers" ON enquete_answers FOR SELECT TO authenticated USING (true); -- Usually results are public, but maybe anonymity is needed? For now public.
