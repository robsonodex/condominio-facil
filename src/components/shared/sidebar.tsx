...
const navItems: NavItem[] = [
    ...
    { href: '/moradores', label: 'Moradores', icon: <Users className="h-5 w-5" />, roles: ['sindico', 'porteiro'] },
    { href: '/unidades', label: 'Unidades', icon: <Home className="h-5 w-5" />, roles: ['sindico', 'porteiro'] },
